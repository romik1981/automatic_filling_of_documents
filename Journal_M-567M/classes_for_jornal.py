...
class JornalRDT(DataJornal):
    ...
    def __init__(self, date_time_begin=datetime.datetime.now(), type_work=None):
...
if __name__ == '__main__':
    ...
    # журнал DEK
    data_4 = JornalDEK(type_work='тест')
    ...
    # журнал CKT
    data_5 = JornalCKT(type_work='тест')
    ...
    # Журнал NSD_SPO
    data_6 = JornalNSD_SPO(type_work='тест')
    ...
    # Журнал RDT
    data_7 = JornalRDT(type_work='тест')
    ...
    # Технический журнал
    data_8 = TechnicalJornal(type_work='тест')
